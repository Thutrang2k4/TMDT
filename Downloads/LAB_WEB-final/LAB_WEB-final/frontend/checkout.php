...
<head>
    ...
    <style>
        ...
        .gender-radio { display:flex; gap:20px; margin-bottom:15px; }
        .add-guest-btn {
            background:#28a745;
            color:#fff;
            border:none;
        ...
        .total-box{font-size:20px;font-weight:bold;color:#e67e22;margin-top:15px}
    </style>
</head>
<body>
                    ...
                    <table class="table table-bordered align-middle" id="guestTable">
                        ...
                        <tbody>
                            <tr data-base="<?php echo $tour['price'] ?? 0; ?>">
                                ...
                                <td>
                                    <input type="date" class="form-control depart-date" onchange="checkDate(this)">
                                </td>
                                <td>
            ...
            <div class="info-box tour-info">
                ...
                <?php foreach ($cart_items as $item): ?>
                    <div class="mb-3">
                        ...
                        <strong>Ngày khởi hành:</strong> <?php echo htmlspecialchars($item['day_start'] ?? '-'); ?><br>
...
<div class="modal fade" id="qrModal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content text-center p-4">
      ...
      <img src="assets/images/qr-payment.png"
